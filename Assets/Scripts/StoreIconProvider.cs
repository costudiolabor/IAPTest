...
public class StoreIconProvider
{
   ...
   public static void Initialize(ProductCollection Products)
   {
      if (Icons.Count == 0)
      {
         ...
         foreach (Product product in Products.all)  // загрузка икнок товаров !!!название icon должно совпадать с ID
         {
